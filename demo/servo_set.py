...
class Ui_ServoSet(object):
    def setupUi(self, ServoSet):
        ...
        self.gridLayout.addWidget(self.btn_servo_5, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_servo_3, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_servo_4, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_servo_3, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_servo_4, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_servo_1, 1, 1, 1, 1)
        self.lineEdit_servo_0 = QtWidgets.QLineEdit(ServoSet)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_servo_0.sizePolicy().hasHeightForWidth())
        self.lineEdit_servo_0.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lineEdit_servo_0.setFont(font)
        self.lineEdit_servo_0.setObjectName("lineEdit_servo_0")
        self.gridLayout.addWidget(self.lineEdit_servo_0, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_servo_2, 2, 1, 1, 1)
    ...
    def retranslateUi(self, ServoSet):
        ...
        self.btn_servo_5.setText(_translate("ServoSet", "故障复位"))
        ...
        self.btn_servo_3.setText(_translate("ServoSet", "正向点动"))
        self.btn_servo_4.setText(_translate("ServoSet", "反向点动"))
